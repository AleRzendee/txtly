...
const Header = () => {
  ...
  return (
    <header id="header" className="fixed top-0 left-0 w-full bg-gray-950 bg-opacity-90 backdrop-blur-md text-white shadow-md z-50">
      <div className="container mx-auto flex items-center justify-between py-4 px-6">
        ...
        <Link href="/login" className="hidden md:block bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-lg transition">
          Acesse o Editor
        </Link>
      ...
      {isOpen && (
        <nav className="md:hidden flex flex-col items-center bg-gray-900 text-lg py-4">
          ...
          <Link href="/login" className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 mt-3 rounded-lg transition">
            Acesse o Editor
          </Link>
        </nav>
      )}
